...
namespace Univisia.Finance.Data.Migrations
{
    ...
    [Migration("20230211161513_AddedPushSubscriptionEntity")]
    partial class AddedPushSubscriptionEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.BankAccount", b =>
                {
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.Currency", b =>
                {
                    b.Property<int>("CurrencyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.Loan", b =>
                {
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.LoanStatus", b =>
                {
                    b.Property<int>("LoanStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.PushSubscription", b =>
                {
                    b.Property<int>("PushSubscriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PushSubscriptionId"), 1L, 1);

                    b.Property<int>("UserDeteilId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PushSubscriptionId", "UserDeteilId");

                    b.HasIndex("UserDeteilId");

                    b.ToTable("PushSubscriptions");
                });

            modelBuilder.Entity("Univisia.Finance.Data.Models.SupportRequest", b =>
                {
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.UserDetail", b =>
                {
                    b.Property<int>("UserDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Univisia.Finance.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.BankAccount", b =>
                {
                    b.HasOne("Univisia.Finance.Data.Models.Currency", "Currency")
                        .WithMany("BankAccounts")
                        .HasForeignKey("CurrencyId")
                        .IsRequired()
                        .HasConstraintName("FK_BankAccount_Currency");

                    b.HasOne("Univisia.Finance.Data.Models.UserDetail", "UserDetail")
                        .WithMany("BankAccounts")
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.Loan", b =>
                {
                    b.HasOne("Univisia.Finance.Data.Models.UserDetail", "ContactDetail")
                    ...
                    b.HasOne("Univisia.Finance.Data.Models.LoanStatus", "LoanStatus")
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.PushSubscription", b =>
                {
                    b.HasOne("Univisia.Finance.Data.Models.UserDetail", "UserDeteil")
                        .WithMany("PushSubscriptions")
                        .HasForeignKey("UserDeteilId")
                        .IsRequired()
                        .HasConstraintName("FK_PushSubscription_UserDetail");

                    b.Navigation("UserDeteil");
                });
            ...
            modelBuilder.Entity("Univisia.Finance.Data.Models.Transaction", b =>
                {
                    b.HasOne("Univisia.Finance.Data.Models.BankAccount", "BankAccount")
                        .WithMany("Transactions")
                        .HasForeignKey("BankAccountId")
                        .HasConstraintName("FK_Transactions_BankAccount");

                    b.HasOne("Univisia.Finance.Data.Models.Loan", "Loan")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("UserCurrency", b =>
                {
                    b.HasOne("Univisia.Finance.Data.Models.Currency", null)
                        .WithMany()
                        .HasForeignKey("CurrencyId")
                        .IsRequired()
                        .HasConstraintName("FK_UserCurrency_Currency");

                    b.HasOne("Univisia.Finance.Data.Models.UserDetail", null)
                        .WithMany()
                        .HasForeignKey("UserDetailId")
                        .IsRequired()
